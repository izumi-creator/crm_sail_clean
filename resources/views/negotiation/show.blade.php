                    ...
                    <div class="accordion-content hidden pt-4 px-6">
                        <div class="grid grid-cols-2 gap-6">
                            <div class="col-span-2">
                                ...
                                <pre class="mt-1 p-2 min-h-[75px] border rounded bg-gray-50 whitespace-pre-wrap text-sm font-sans leading-relaxed">{{ $negotiation->memo }}</pre>
                            </div>
                       </div>
                    </div>                   
                </div>
                    ...
                    <div>
                        ...
                        <select id="record1" name="record1" class="w-full p-2 border rounded bg-white">
                            ...
                            @foreach (config('master.records_1') as $key => $label)
                                <option value="{{ $key }}" @selected($negotiation->record1 == $key)>{{ $label }}</option>
                            @endforeach
                        </select>
                        @errorText('record1')
                    </div>               
                    ...
                    <div class="col-span-2 mt-2 -mx-6">
                        ...
                        <div class="accordion-content hidden pt-4 px-6">
                            <div class="grid grid-cols-2 gap-6">
                                <div class="col-span-2">
                                    <label class="block text-sm font-semibold text-gray-700 mb-1">メモ欄</label>
                                    <textarea name="memo" rows="3" class="mt-1 p-2 border rounded w-full bg-white">{{ $negotiation->memo }}</textarea>
                                    @errorText('memo')
                                </div>
                            </div>
                        </div>
