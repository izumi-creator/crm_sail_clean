...
@section('content')
    ...
    <div class="w-full p-6"> <!-- ✅ ダッシュボードと統一 -->
        <h2 class="text-2xl font-bold mb-4 text-gray-800">受任案件一覧</h2>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
            <form method="GET" action="{{ route('business.index') }}">
                ...
                <div class="mt-4 flex justify-end space-x-2">
                    ...
                    <a href="{{ route('business.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded">検索条件クリア</a>
                    <a href="{{ route('business.create') }}" class="bg-green-500 text-white px-4 py-2 rounded">新規登録</a>
                </div>
            </form>
        </div>
...
<div class="mb-10">
    <h2 class="text-xl font-semibold mb-4">検索結果（{{ $businesses->total() }}件）</h2>
    <div class="p-4 border rounded-lg shadow bg-white">
        ...
        <div class="mt-8 flex items-center space-x-4">
            <p class="text-gray-600">
                {{ __('pagination.showing', ['first' => $businesses->firstItem(), 'last' => $businesses->lastItem(), 'total' => $businesses->total()]) }}
            </p>
