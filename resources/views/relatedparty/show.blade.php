        ...
        <div class="border border-gray-300 overflow-hidden">
            ...
            <div class="grid grid-cols-2 gap-6 pt-0 pb-6 px-6 text-sm">
               ...
               <div>
                ...
                <!-- 受任案件ID -->
                <div>
                    <label class="font-bold">受任案件ID</label>
                    <div class="mt-1 p-2 border rounded bg-gray-50">
                        {!! $relatedparty->business_id ?: '&nbsp;' !!}
                    </div>
                </div>
                <!-- 顧問相談ID -->
                <div>
                    <label class="font-bold">顧問相談ID</label>
                    <div class="mt-1 p-2 border rounded bg-gray-50">
                        {!! $relatedparty->advisory_id ?: '&nbsp;' !!}
                    </div>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('relatedparty.update', $relatedparty->id) }}">
                ...
                <div class="grid grid-cols-2 gap-6 pt-0 pb-6 px-6 text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" name="business_id" value="{{ $relatedparty->business_id }}"
                               class="w-full p-2 border rounded bg-white">
